...
public class String01Main {
	...
	public static void main(String[] args) {
		...
		str1.concat(str2); // 원본 변경 안됨
		System.out.println(str1);
		str1 = str1.concat(str2);// 원본을 변경 시키고 싶다면...
		System.out.println(str1);
		...
		str3 = "";    // 문자열 객체 존재하나 비어있는 문자열
		System.out.println(str3.length());
		str3 = null;   // null, 객체 자체가 존재 안함
		//System.out.println(str3.length());
		
		
		System.out.println();
		System.out.println("charAt()"); // 문자열 안의 특정위치(index)의 문자 리턴, 인덱스 범위 벗어나면 StringIndexOutOfBoundsException
											// 문자열 인덱스는 0 부터 시작!
		...
		System.out.println();
		System.out.println("split(regex)"); // 문자열을 주어진 문자열(delimeter: 구분자)로 쪼개어 String[] 리턴
		String str4 = "HH:MM:SS";
		String [] strings = str4.split(":");
		System.out.println(Arrays.toString(strings));
		
		// 년, 월, 일 , 시, 분 , 초 분리하기
		str4 = "2020-02-17 18:39:52";
		String date = str4.split(" ")[0];
		String time = str4.split(" ")[1];
		String year = date.split("-")[0];
		String minute = time.split(":")[1];
		System.out.println("연도: " + year + " 분:" + minute);
		...
		System.out.println();
		System.out.println("String.format()");  // 서식화된 문자열 리턴
